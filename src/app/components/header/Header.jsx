    ...
    >
      ...
      >
        <div className="flex flex-col justify-center lg:flex-row items-center h-[300px] mx-2">
          ...
          />
          <h1 className="bg-gradient-to-r from-fuchsia-400 to-blue-400 bg-clip-text text-transparent text-4xl lg:text-6xl font-bold lg:ml-5 py-2 drop-shadow-[0_0_2px_white] leading-tight">
