...
import FacebookPagePlugin from "@/app/components/Facebookpage/Facebookpage";
import Tiktokpage from "@/app/components/Tiktokpage/Tiktokpage";
  ...
  return (
    <div>
      ...
      <div className="container max-w-[1320px] mx-auto py-10">
        ...
        <div className="my-5">
          <div
            className="text-center text-4xl font-bold bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent"
            data-aos="zoom-in"
          >
            FACEBOOK
          </div>
          <div
            className="grid grid-cols-1 lg:grid-cols-1 gap-5 place-items-center justify-center items-center bg-gradient-to-r from-pink-200 to-blue-200 rounded-2xl py-10 px-5 mt-10 ring-2 ring-blue-500/50"
            data-aos="zoom-in"
          >
            <FacebookPagePlugin />
            {/* <div
