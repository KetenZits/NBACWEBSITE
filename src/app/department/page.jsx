...
const DepartmentPage = () => {
  ...
  const departmentModalContent = {
    kindergarten: {
      ...
      content: {
        contact: {
          phone: "034-311263",
          email: "npkindergarten@gmail.com",
          location:
            "97/1 หมู่ที่ 3 ตำบลคลองใหม่ อำเภอสามพราน จังหวัดนครปฐม รหัสไปรษณีย์ 73110 (42 ไร่)",
    ...
    primary: {
      ...
      content: {
        contact: {
          phone: "034-311263",
          email: "nakprasith@yahoo.com",
          location:
            "97/1 หมู่ที่ 3 ตำบลคลองใหม่ อำเภอสามพราน จังหวัดนครปฐม รหัสไปรษณีย์ 73110",
          hours: "จันทร์-ศุกร์ 07:30-17:00",
        },
      },
    },
    secondary: {
      ...
      content: {
        contact: {
          phone: "034-311263",
          email: "nakprasith.sch@gmail.com",
          location:
            "97/1 หมู่ที่ 3 ตำบลคลองใหม่ อำเภอสามพราน จังหวัดนครปฐม รหัสไปรษณีย์ 73110",
          hours: "จันทร์-ศุกร์ 07:30-17:00",
        },
    ...
    college: {
      ...
      content: {
        contact: {
          phone: "034-311263",
          email: "nakprasith.nbac@gmail.com",
          location:
            "97/1 หมู่ที่ 3 ตำบลคลองใหม่ อำเภอสามพราน จังหวัดนครปฐม รหัสไปรษณีย์ 73110",
  ...
  const currentModal = selectedDepartment
    ? departmentModalContent[selectedDepartment]
    : null;
  ...
  return (
    <>
        ...
        <div className="relative z-10">
          ...
          <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1
                className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent mb-6"
                data-aos="fade-up"
              >
                Another Department
              </h1>
              ...
              <div className="space-y-6">
                {contactInfo1.map((info, index) => (
                  <div
                    ...
                    className="bg-white/70 hover:skew-y-1 hover:skew-x-1 backdrop-blur-xl border border-blue-200/50 rounded-3xl p-6 hover:bg-white/80 hover:shadow-xl hover:shadow-blue-200/20 transition-all duration-500 group cursor-pointer"
                    data-aos="fade-right"
                  >
      ...
      {selectedDepartment && currentModal && (
        ...
        >
          <div
            className={`bg-gradient-to-br ${currentModal.bgGradient} border ${currentModal.borderColor} rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative`}
          >
            {/* Close Button */}
            <button
              onClick={closeModal}
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">
                      {currentModal.content.contact.phone}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-gray-500" />
                    <span className="text-gray-700">
                      {currentModal.content.contact.email}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="w-4 h-4 text-gray-500" />
                    <span className="text-gray-700">
                      {currentModal.content.contact.location}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Clock className="w-4 h-4 text-gray-500" />
                    <span className="text-gray-700">
                      {currentModal.content.contact.hours}
                    </span>
                  </div>
                </div>
              </div>
