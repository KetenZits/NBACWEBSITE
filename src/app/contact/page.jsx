  ...
  const contactInfo = [
    {
      ...
      title: 'Address',
      details: ['123 School Road', 'Bangkok, Thailand 10110'],
      color: 'text-pink-500'
    },
    {
    ...
    },
    {
      ...
      title: 'Email',
      details: ['info@school.ac.th', 'admissions@school.ac.th'],
        ...
        <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Ready to join our amazing school community? We'd love to hear from you! 
              Reach out through any of these channels and let's start your journey! ✨
            </p>
          </div>
        </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="bg-white/70 backdrop-blur-xl border border-blue-200/50 rounded-3xl p-6 hover:bg-white/80 hover:shadow-xl hover:shadow-blue-200/20 transition-all duration-500 group"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {info.details.map((detail, idx) => (
                        <p key={idx} className="text-gray-600 hover:text-gray-800 transition-colors">
                          {detail}
                        </p>
                      ))}
                    </div>
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-blue-200/50 rounded-3xl p-8 mb-16 hover:bg-white/80 hover:shadow-xl hover:shadow-blue-200/20 transition-all duration-500">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">Stay connected and see what's happening at our school! 📱</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.url}
                  className={`group relative bg-gradient-to-br ${social.color} p-6 rounded-2xl hover:scale-105 transition-all duration-300 hover:shadow-2xl ${social.hoverColor} overflow-hidden`}
                >
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-pink-200/50 rounded-3xl p-8 hover:bg-white/80 hover:shadow-xl hover:shadow-pink-200/20 transition-all duration-500">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">Come visit our beautiful campus!</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-pink-50 rounded-2xl p-8 text-center border border-blue-200/30">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Our School</h3>
              <p className="text-gray-600 mb-4">123 School Road, Bangkok, Thailand 10110</p>
